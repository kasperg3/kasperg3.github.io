/* ============================================================================
   ...
   Same engine, same ranking, same rows as /search/; two things differ. It is
   smaller (no metadata line, no status), and pressing a result hands off to
   /search/ with the query and the chosen document in the URL, so the reader
   lands on the analysis of the thing they picked. The corner link on each row
   still goes straight to the source.
